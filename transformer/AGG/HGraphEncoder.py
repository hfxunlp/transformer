...
class Encoder(EncoderBase):
	...
	def __init__(self, isize, nwd, num_layer, fhsize=None, dropout=0.0, attn_drop=0.0, num_head=8, xseql=512, ahsize=None, norm_output=False, num_sub=1, num_unit=1):
		...
		self.nets = nn.ModuleList([EncoderLayerStack(isize, _fhsize, dropout, attn_drop, num_head, _ahsize, num_layer - num_sub * num_unit), EncoderLayer(isize, _fhsize, dropout, attn_drop, num_head, _ahsize, num_sub, num_unit)])
