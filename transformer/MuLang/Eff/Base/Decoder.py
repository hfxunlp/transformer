...
from modules.mulang.eff.base import LayerNorm, MBLinear, ResSelfAttn, ResCrossAttn, PositionwiseFF
...
class DecoderLayer(DecoderLayerBase):
	...
	def forward(self, inpute, inputo, taskid=None, src_pad_mask=None, tgt_pad_mask=None, query_unit=None):
...
class Decoder(DecoderBase):
	...
	def forward(self, inpute, inputo, taskid=None, src_pad_mask=None):
