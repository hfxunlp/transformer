...
from modules.base import ResCrossAttn, Dropout, PositionwiseFF
...
class DecoderLayer(nn.Module):
	...
	def __init__(self, isize, fhsize=None, dropout=0.0, attn_drop=0.0, num_head=8, ahsize=None, norm_residual=norm_residual_default):
